...
console.info(window.Echo.channel('Event'));
/*window.Echo = new Echo({
   broadcaster: 'pusher',
   key: process.env.MIX_PUSHER_APP_KEY,
   wsHost: window.location.hostname,
...
window.Echo.channel('Event').listen('.Event', function (e) {
  console.log(e);
  return e;
});
...
__webpack_require__(/*! C:\xampp\htdocs\pfe\LaravelAngularPfe\Backend\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\pfe\LaravelAngularPfe\Backend\resources\sass\app.scss */"./resources/sass/app.scss");
